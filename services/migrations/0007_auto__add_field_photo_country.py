...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Photo.country'
        db.add_column(u'services_photo', 'country',
                      self.gf('django.db.models.fields.CharField')(default='ES', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Photo.country'
        db.delete_column(u'services_photo', 'country')
