...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'services_comment', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 10, 21, 0, 0), blank=True),
                      keep_default=False)


        # Changing field 'Category.date'
        db.alter_column(u'services_category', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'services_comment', 'date')


        # Changing field 'Category.date'
        db.alter_column(u'services_category', 'date', self.gf('django.db.models.fields.DateTimeField')())
