...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomUser.social_network'
        db.add_column(u'services_customuser', 'social_network',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomUser.social_network'
        db.delete_column(u'services_customuser', 'social_network')
