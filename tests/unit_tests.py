...
class ImgResizerTest(TestCase):
    @classmethod
    def setUpClass(cls):
        cls.img_original_landscape = os.path.join(PROJECT_ROOT, 'tests', 'fixtures', 'imgs', 'test_img_landscape.png')
        cls.img_original_portrait = os.path.join(PROJECT_ROOT, 'tests', 'fixtures', 'imgs', 'test_img_portrait.png')
        cls.img_original_copy = os.path.join(PROJECT_ROOT, 'tests', 'fixtures', 'imgs', 'test_img_copy.png')
        cls.img_resized = os.path.join(PROJECT_ROOT, 'tests', 'fixtures', 'imgs', 'resized.png')

    def setUp(self):
        self.img_resized = os.path.join(PROJECT_ROOT, 'tests', 'fixtures', 'imgs', 'resized.png')
    ...
    def test_resize_img_overwriting_original(self):
        img_original = os.path.join(PROJECT_ROOT, 'tests', 'fixtures', 'imgs', 'test_img.png')
